...
public class Escenario10 {
    /* Para cada estructura concurrente creamos 1 threads que agrega 1000 elementos 
    y otro que lo elimina. El thread que los elimina duerme un segundo a la mitad de su ejecucion*/

    
    public static void main(String[] args) throws Exception {
        
        File file = new File("src/logs/timeEscenario10.txt");
        file.createNewFile(); 
          
        int reps = 1000;
        FileWriter fileTime = new FileWriter("src/logs/timeEscenario10.txt");
